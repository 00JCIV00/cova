...
#    chmod +x covademo-completion.zsh
#
...
cmd_args=(
    ...
    "covademo_struct-cmd_inner-cmd" "help usage --in-bool --in-float --help --usage"
...
# Register the completion function for covademo
compdef _covademo_completions covademo