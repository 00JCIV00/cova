...
pub const setup_cmd: CommandT = .{
    ...
    .sub_cmds = &.{
        ...
        .{ .name = "nest-1", .description = "Nested Level 1.", .sub_cmds = &.{.{ .name = "nest-2", .description = "Nested Level 2.", .sub_cmds = &.{.{ .name = "nest-3", .description = "Nested Level 3.", .allow_inheritable_opts = true, .sub_cmds = &.{.{
            .name = "nest-4",
    ...
    .opts = &.{
        ...
        .{
            ...
            .val = ValueT.ofType([]const u8, .{
                ...
                .valid_fn_io = Value.ValidationFns.validFilepath,
            }),
        },
        .{
            .name = "ordinal_opt",
